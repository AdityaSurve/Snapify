...
const Main = () => {
  ...
  return (
    <div className="bg-bannerBg h-screen">
      <Navbar />
      <div className="image_editor">
        <div className="card bg-[#FE9A3E] p-4 m-4 rounded-xl w-full h-[100%] hover:shadow-xl backdrop-blur-sm bg-gray-800/30 self-end border-gray-400/50 border">
          <div className="card_header">
            <h2 className="font-bold text-4xl font-jost">Image Editor</h2>
          </div>
              ...
              <div className="side_body">
                ...
                <div className="filter_slider">
                  <div className="label_bar">
                    <label htmlFor="range">Percentage</label>
                    <span>100%</span>
                  </div>
                  <input
                    name={property.name}
